...
//			for (Syuser u : al) {
//				List<Syrole> rl = (List)qr.query(conn, "SELECT syrole.* FROM syrole JOIN syuser_syrole ON syuser_syrole.SYROLE_ID = syrole.ID WHERE syuser_syrole.SYUSER_ID = ?", new BeanListHandler<>(Syrole.class), u.getId());
