  ...
  <table class="table tb-type2" id="prompt">
    ...
    <table class="table tb-type2">
      ...
      <?php foreach ($data_array as $val) {?>
		<tr class="hover edit">
          <td class="w24"><input name="shop_id[]" value="<?php echo $val['vid']?>" class="checkitem" type="checkbox"></td>
          <td class="name w300"><?php echo $val['message']?></td>
          <td class="align-center"><?php echo $val['uid']?></td>
          <td class="align-center"><?php echo $val['username']?></td>
          <td class="nowarp align-center"><p><?php echo $val['uip']?></p></td>
          <td class="nowarp align-center"><p><?php echo date('Y-m-d H:i',$val['time'])?></p></td>
        </tr>
        <?php }?>
        <?php } else {?>
        <tr class="no_data">
