...
$(document).ready(function(){
	...
	$('#workspace').attr('src','content2.php');
    ...
    <tr>
      <td colspan="2" class="mainhd" height="90"><div class="layout-header"> <!-- Title/Logo - can use text instead of image -->
          ...
          <nav id="nav" class="main-nav">
            <ul>
           <li><a class="link actived" id="nav_dashboard" href="index.php" onclick=""><span>接口</span></a></li>
          ...
          <div class="loca"><strong>您的位置:</strong>
            <div id="crumbs" class="crumbs"><span>接口</span><span class="arrow">&nbsp;</span><span>接口设置</span></div>
          </div>
        </div>
        <div> </div></td>
    </tr>
          ...
          <ul style="display: block;" id="sort_setting">
            <li>
              <dl>
                ...
                <dd>
                  <ol>
                    <li><a class="selected" href="javascript:void(0);" name="item_base_information" id="item_base_information" onclick="">接口设置</a></li>
