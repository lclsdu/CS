...
$(document).ready(function(){
	...
	$('#workspace').attr('src','picshow_list.php');
      ...
      <td colspan="2" class="mainhd" height="90"><div class="layout-header"> <!-- Title/Logo - can use text instead of image -->
          ...
          <nav id="nav" class="main-nav">
           ...
           <li><a class="link" id="nav_dashboard" href="index.php" onclick=""><span>接口</span></a></li>
            ...
            <li><a class="link actived" id="nav_setting" href="index4.php"><span>图片新闻</span></a></li>
            <li><a class="link" id="nav_setting" href="index5.php"><span>推送</span></a></li>
            </ul>
          </nav>
          <div class="loca"><strong>您的位置:</strong>
            <div id="crumbs" class="crumbs"><span>图片新闻</span><span class="arrow">&nbsp;</span><span>图片新闻管理</span></div>
          </div>
        </div>
        <div> </div></td>
    </tr>
          ...
          <ul style="display: block;" id="sort_setting">
            <li>
              <dl>
                ...
                <dd>
                  <ol>
                    <li><a class="selected" href="javascript:void(0);" name="item_base_information" id="item_base_information" onclick="">图片新闻管理</a></li>
